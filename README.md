...
The docker on first run will download the same version as tagged of `FTB Revelation` and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
...
* MOTD "FTB Revelation Server Powered by Docker"
* LEVEL world
...
## Source
Github: https://github.com/Goobaroo/docker-ftbrevelation

Docker: https://hub.docker.com/repository/docker/goobaroo/ftbrevelation